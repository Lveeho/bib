...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/cssfront/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{asset('css/cssfront/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{asset('css/cssfront/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/cssfront/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{asset('css/cssfront/bootstrap-datepicker.css')}}">
    <link rel="stylesheet" href="{{asset('css/cssfront/animate.css')}}">

    <link rel="stylesheet" href="{{asset('css/cssfront/mediaelementplayer.css')}}">
    <!--https://cdn.jsdelivr.net/npm/mediaelement@4.2
    .7/build/mediaelementplayer
    .min.css-->


    <link rel="stylesheet" href="{{asset('css/cssfront/flaticon.css')}}">

    <link rel="stylesheet" href="{{asset('css/cssfront/aos.css')}}">
...
<div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url('../../public/images/front/hero_1.jpg');"
         data-aos="fade"
                    ...
                    <div class="rounded border jobs-wrap">
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="../../public/images/front/company_logo_blank.png" alt="Image" class="img-fluid mx-auto">
                            </div>
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center freelance">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="../../public/images/front/logo_1.png" alt="Image" class="img-fluid mx-auto">
                            </div>
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
                        ...
                        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center partime">
                            <div class="company-logo blank-logo text-center text-md-left pl-3">
                                <img src="../../public/images/front/logo_2.png" alt="Image" class="img-fluid mx-auto">
                            </div>
                            <div class="job-details h-100">
                                <div class="p-3 align-self-center">
                ...
                <div class="col-md-6 mb-5 mb-md-0">
                    ...
                    <div class="img-border">
                        <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                            ...
                            <img src="../../public/images/front/hero_2.jpg" alt="Image" class="img-fluid rounded">
                        </a>
                    </div>
    ...
    <div class="site-blocks-cover overlay inner-page" style="background-image: url(../../public/images/front/hero_2.jpg);"
        ...
        <div class="container">
            ...
            <div class="nonloop-block-15 owl-carousel">
                ...
                <div class="media-with-text">
                    <div class="img-border-sm mb-4">
                        <a href="#" class="image-play">
                            <img src="../../public/images/front/img_1.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                ...
                <div class="media-with-text">
                    <div class="img-border-sm mb-4">
                        <a href="#" class="image-play">
                            <img src="../../public/images/front/img_2.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                    <h2 class="heading mb-0 h5"><a href="#">Jobs are made easy</a></h2>
                    <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
                ...
                <div class="media-with-text">
                    <div class="img-border-sm mb-4">
                        <a href="#" class="image-play">
                            <img src="../../public/images/front/img_3.jpg" alt="" class="img-fluid">
                        </a>
                    </div>
                    <h2 class="heading mb-0 h5"><a href="#">Jobs are made easy</a></h2>
                    <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
...
<script src="{{asset('js/jsfront/jquery-migrate-3.0.1.min.js')}}"></script>
<script src="{{asset('js/jsfront/jquery-ui.js')}}"></script>
<script src="{{asset('js/jsfront/popper.min.js')}}"></script>
<script src="{{asset('js/jsfront/bootstrap.min.js')}}"></script>
<script src="{{asset('js/jsfront/owl.carousel.min.js')}}"></script>
<script src="{{asset('js/jsfront/jquery.stellar.min.js')}}"></script>
<script src="{{asset('js/jsfront/jquery.countdown.min.js')}}"></script>
<script src="{{asset('js/jsfront/jquery.magnific-popup.min.js')}}"></script>
<script src="{{asset('js/jsfront/bootstrap-datepicker.min.js')}}"></script>
<script src="{{asset('js/jsfront/aos.js')}}"></script>


<script src="{{asset('js/jsfront/mediaelement-and-player.min.js')}}"></script>
